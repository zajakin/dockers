...
../configure --disable-shared --enable-stl --with-cxx=20 --enable-utf8only --enable-intl --enable-xlocale --enable-webviewwebkit --with-gtk=4 # --without-libtiff --enable-monolithic --enable-webview --enable-unicode --enable-cxx13
make
popd
